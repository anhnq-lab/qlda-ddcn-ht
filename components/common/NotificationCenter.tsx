...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({ isOpen, onClose }) => {
    ...
    const notifications = useMemo<Notification[]>(() => {
        ...
        (tasks || [])
            ...
            .forEach((task, idx) => {
                ...
                notifs.push({
                    ...
                    iconColor: daysUntilDue <= 2 ? 'text-primary-500 bg-primary-50' : 'text-blue-500 bg-blue-50'
                });
            });
        ...
        notifs.push({
            ...
            message: 'Quyết định phê duyệt dự án đã được ký số',
            time: 'Hôm qua',
            read: true,
            link: '/documents',
            icon: FileText,
    ...
    return (
        <>
            ...
            {/* Dropdown */}
            <div className="absolute right-0 top-full mt-2 w-96 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-gray-200 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                {/* Header */}
                <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between bg-slate-50 dark:bg-slate-800">
                    ...
                    {notifications.length === 0 ? (
                        ...
                        notifications.map(notif => (
                            <div
                                ...
                                className={`px-4 py-3 flex gap-3 transition-colors cursor-pointer group ${notif.read ? 'bg-white dark:bg-slate-800 hover:bg-gray-50' : 'bg-blue-50/30 hover:bg-blue-50/50'
                                    }`}
                            >
                                {/* Icon */}
                ...
                {/* Footer */}
                <div className="px-4 py-3 border-t border-gray-200 bg-slate-50 dark:bg-slate-800 flex items-center justify-between">
