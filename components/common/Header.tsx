            ...
            <div className="flex items-center gap-2 sm:gap-4 flex-1">
                ...
                <div className="relative flex-1 max-w-md hidden sm:flex">
                    ...
                    <button
                        ...
                        className="block w-full pl-10 pr-3 py-2 text-left border border-border rounded-xl bg-slate-50 dark:bg-slate-800 hover:bg-bg-surface dark:hover:bg-slate-700 text-sm text-slate-500 dark:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-all cursor-pointer group shadow-lg"
                    >
                        Tìm kiếm dự án, dữ liệu...
                        <kbd className="absolute right-2 top-1/2 -translate-y-1/2 hidden sm:inline-flex items-center gap-1 px-1.5 py-0.5 bg-bg-surface text-[10px] font-bold text-slate-400 dark:text-slate-300 rounded border border-border">
                            Ctrl+K
                        </kbd>
                    </button>
                </div>
