        ...
        <Dropdown.Root>
            ...
            <Dropdown.Portal>
                <Dropdown.Content
                    ...
                    align="end"
                    className={cn(
                        "z-[60] min-w-[12rem] bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-800 py-1",
                            ...
                            <Dropdown.Item
                                ...
                                className={cn(
                                    ...
                                    item.variant === 'danger'
                                        ...
                                        : "text-slate-700 dark:text-slate-300 focus:bg-slate-50 dark:bg-slate-800 dark:focus:bg-slate-800"
                                )}
                            >
