        ...
        <Dropdown.Root>
            <Dropdown.Trigger asChild>
                {trigger || (
                    <button
                        className={cn(
                            "p-1.5 hover:bg-bg-muted rounded-lg text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500",
                            className
                        )}
            ...
            <Dropdown.Portal>
                <Dropdown.Content
                    ...
                    align="end"
                    className={cn(
                        "z-[60] min-w-[12rem] bg-bg-surface rounded-xl shadow-xl border border-border py-1",
                            ...
                            <Dropdown.Item
                                ...
                                className={cn(
                                    ...
                                    item.variant === 'danger'
                                        ...
                                        : "text-txt-secondary focus:bg-slate-50 dark:focus:bg-slate-700"
                                )}
                            >
