...
export const AIDocumentDrafter: React.FC<AIDocumentDrafterProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="bg-bg-surface rounded-xl shadow-2xl w-[700px] max-h-[85vh] flex flex-col border border-border">
                {/* Header */}
                <div className="flex items-center justify-between px-5 py-4 border-b border-border">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-bold text-txt-secondary">
                                Soạn văn bản AI
                            </h2>
                            <p className="text-[11px] text-txt-placeholder truncate max-w-[400px]">
                                {projectName}
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-5">
                    ...
                    <div className="mb-4">
                        <label className="block text-xs font-medium text-txt-muted mb-2">
                            Chọn loại văn bản
                        </label>
                            ...
                            {DOCUMENT_TYPES.map(dt => (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-txt-placeholder mt-0.5 leading-relaxed">
                                            {dt.description}
                                        </p>
                                    </div>
                                </button>
                    ...
                    {draftContent && (
                        <div className="mt-4">
                            <div className="flex items-center justify-between mb-2">
                                <h3 className="text-xs font-bold text-txt-muted flex items-center gap-1.5">
                                    <FileText size={14} />
                                    Bản nháp
                                </h3>
                                <div className="flex items-center gap-1.5">
                                    <button
                                        onClick={handleGenerate}
                                        disabled={loading}
                                        className="text-[11px] px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-600 text-txt-muted hover:bg-bg-subtle dark:hover:bg-slate-700 transition-colors flex items-center gap-1"
                                    >
                            ...
                            <div className="p-4 bg-bg-subtle dark:bg-slate-900 rounded-lg border border-border max-h-[50vh] overflow-y-auto">
                                <pre className="text-xs text-txt-secondary whitespace-pre-wrap font-sans leading-relaxed">
                                    {draftContent}
                                </pre>
                            </div>
                        </div>
