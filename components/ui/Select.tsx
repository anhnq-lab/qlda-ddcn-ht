...
export const Select: React.FC<SelectProps> = ({
    ...
    return (
        <div className={cn("relative", fullWidth && "w-full", className)}>
                ...
                <Popover.Trigger asChild>
                    <button
                        ...
                        className={cn(
                            ...
                            "disabled:bg-bg-muted disabled:text-txt-muted disabled:cursor-not-allowed",
                            sizeStyles[size],
                            ...
                            hasError
                                ...
                                : "border-border focus:border-primary-500 focus:ring-primary-100 dark:focus:ring-primary-900"
                        )}
                    >
                        <span className={cn("truncate", hasValue ? "text-txt-primary" : "text-txt-placeholder")}>
                            {displayValue()}
                        </span>
                        <div className="flex items-center gap-1 shrink-0">
                            {clearable && hasValue && (
                                <span
                                    onClick={handleClear}
                                    className="p-0.5 hover:bg-bg-muted rounded transition-colors"
                                >
                ...
                {usePortal ? (
                    <Popover.Portal>
                        <Popover.Content
                            ...
                            className={cn(
                                "z-[70] bg-bg-elevated border border-border rounded-xl shadow-dropdown overflow-hidden",
                        ...
                        >
                                ...
                                <div className="p-2 border-b border-border">
                                    <div className="relative flex items-center">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-9 pr-3 py-2 bg-bg-subtle border-0 rounded-lg text-sm text-txt-primary placeholder-txt-placeholder focus:outline-none focus:ring-2 focus:ring-focus"
                                        />
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="max-h-60 overflow-y-auto scrollbar-thin">
                                {filteredOptions.length === 0 ? (
                                    <div className="px-4 py-3 text-sm text-txt-muted text-center">
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    option.disabled
                                                        ? "text-txt-placeholder cursor-not-allowed"
                                                        : "hover:bg-bg-hover-row focus:bg-bg-hover-row",
                                                    isSelected
            ...
            {/* Helper/Error Text */}
            {(error || helperText) && (
                <p className={cn("mt-1.5 text-xs", hasError ? "text-red-500 dark:text-red-400" : "text-txt-muted")}>
                    {error || helperText}
                </p>
            )}
        </div>
