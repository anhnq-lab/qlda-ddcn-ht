...
export const MonthlyPlanItemFormSchema = z.object({
    ...
    source_project_plan_item_id: z.string().optional(),
    source_task_id: z.string().optional(),
    source_subtask_id: z.string().optional(),
    source_type: z.enum(['manual', 'from_annual', 'from_project_task', 'from_subtask', 'project_step']).optional(),
    ...
    collaborating_dept_codes: z.array(z.string()).optional().default([]),
