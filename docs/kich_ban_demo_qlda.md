...
graph TD
    ...
    C --> D[Tầng 3: Bộ phận Tài chính - Kế toán thuộc Phòng HC-TH<br/>Quản Lý Hợp Đồng, Phụ L�## 📋 TỔNG QUAN TÍNH NĂNG 13 PHÂN HỆ THEO TRÌNH TỰ SIDEBAR
...
* **Tính năng cốt lõi và nghiệp vụ hành chính:**
  ...
  * Hệ thống chấm điểm KPI nhà thầu tự động dựa trên kết quả nghiệm thu thực tế hiện trường (chất lượng thi công, mức độ tuân thủ tiến độ, an toàn lao động, và tinh thần phối hợp xử lý vướng mắc pháp lý, thanh quyết toán) làm cơ sở tham chiếu khách quan cho công tác đấu thầu trong tương lai.
...
* **Tính năng cốt lõi:**
  ...
  * Tích hợp công nghệ AI OCR trích xuất thông tin tự động khi tải lên file PDF quyết định đã ký số, giúp tự động điền các thông tin pháp lý (số hiệu, ngày ban hành, người ký) vào cơ sở dữ liệu hệ thống, phục vụ công tác tra cứu nhanh của cán bộ.��n lý tiến trình đấu thầu qua mạng (lập hồ sơ mời thầu, hồ sơ yêu cầu, làm rõ thầu, mở thầu và phê duyệt quyết định trúng thầu).
