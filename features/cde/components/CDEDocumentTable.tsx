...
const CDEDocumentTable: React.FC<CDEDocumentTableProps> = ({
    ...
    return (
        <div className="flex-1 bg-bg-surface rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 flex flex-col overflow-hidden min-w-0">
            {/* Toolbar */}
            <div className="px-5 py-3 border-b border-gray-200 dark:border-slate-700 flex justify-between items-center bg-bg-subtle">
            ...
            <div className="flex-1 overflow-y-auto">
                {isLoading ? (
                    ...
                    <table className="w-full text-left text-sm">
                        <thead className="bg-bg-surface text-[10px] uppercase font-bold text-gray-400 dark:text-slate-400 sticky top-0 z-10 border-b border-slate-200 dark:border-slate-700 tracking-wider">
                            <tr>
                                {onToggleSelect && (
