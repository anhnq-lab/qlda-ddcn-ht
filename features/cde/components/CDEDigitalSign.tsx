                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gray-50 dark:bg-slate-700 p-5 rounded-2xl border border-gray-200 dark:border-slate-600 flex items-center gap-4">
                        ...
                        <div className="flex-1 overflow-hidden">
                            ...
                            <p className="text-[10px] text-gray-400 dark:text-slate-400 font-bold uppercase tracking-widest">HỒ SƠ DỰ ÁN • {fileSize}</p>
                        </div>
                    </div>
                    ...
                    {step === 1 && (
                        <div className="text-center py-10">
                            ...
                            <p className="text-gray-400 dark:text-slate-400 font-bold uppercase tracking-widest text-[10px]">Đang đọc thông tin chứng thư số...</p>
                        </div>
                    )}
                    ...
                    {step === 3 && (
                        <div className="text-center py-10">
                            ...
                            <p className="text-gray-400 dark:text-slate-400 font-bold uppercase tracking-widest text-[10px]">Đang ký số văn bản...</p>
                        </div>
                    )}
                </div>
            </div>
