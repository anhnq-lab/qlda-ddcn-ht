                ...
                <div className="p-4 space-y-4 max-h-[70vh] overflow-y-auto">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-2.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-xl text-sm font-medium text-gray-800 dark:text-slate-200 focus:ring-2 focus:ring-blue-100 focus:border-blue-300"
                        >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-3 py-2.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-xl text-sm font-medium text-gray-800 dark:text-slate-200"
                            >
