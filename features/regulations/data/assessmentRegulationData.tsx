      ...
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>#</p>
            <p># **QUY CHẾ**</p>
            <p>**Đánh giá, xếp loại hàng tháng đối với cán bộ, viên chức, người lao động thuộc Ban Quản lý dự án đầu tư xây dựng công trình**</p>
            <p>**Dân dụng** **và Hạ tầng khu vực tỉnh Hà Tĩnh**</p>
            <p>#</p>
          </div>
        )
      },
      ...
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>4. Việc đánh giá, xếp loại viên chức lãnh đạo, quản lý phải dựa vào kết quả hoạt động của cơ quan, đơn vị được giao quản lý, phục trách. Mức độ hoàn thành nhiệm vụ của người đứng đầu không được cao hơn mức độ hoàn thành nhiệm vụ của đơn vị được giao quản lý, phụ trách.</p>
            <p>5. Trường hợp cán bộ, viên chức, lao động không hoàn thành nhiệm vụ do yếu tố khách quan, bất khả kháng thì được xem xét trong quá trình đánh giá, xếp loại.</p>
          </div>
        )
      },
      {
      ...
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>c) Hoàn thành nhiệm vụ (Loại B);</p>
            <p>d) Không hoàn thành nhiệm vụ (Loại C).</p>
          </div>
        )
      },
    ]
    ...
    articles: [
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>- Cán bộ, viên chức, người lao động tự đánh giá, xếp loại hàng tháng đối với bản thân.</p>
          </div>
        )
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>- Thực hiện hiện nghiêm quy tắc ứng xử trong các hoạt động của cơ quan **(tối đa 3 điểm).**</p>
            <p>- Thực hiện nghiêm quy định văn hóa công sở, đạo đức công vụ của viên chức, người lao động **(tối đa 6 điểm).**</p>
            <p>2. Kết quả thực hiện chức trách nhiệm vụ được giao **(tối đa 75 điểm)**</p>
            <p>a) Năng lực và kỹ năng **(tối đa 20 điểm)**</p>
            <p>- Đối với lãnh đạo quản lý (Giám đốc, các Phó Giám đốc, lãnh đạo các phòng):</p>
            <p>+ Chủ động nghiên cứu, cập nhật kịp thời các kiến thức pháp luật và chuyên môn nghiệp vụ; tham mưu đầy đủ, có chất lượng các văn bản phục vụ công tác chỉ đạo, điều hành của cơ quan, phòng chuyên môn theo chỉ đạo của lãnh đạo cấp trên và kế hoạch công tác.</p>
            <p>+ Tham gia xây dựng kế hoạch công tác của cơ quan, của phòng theo lĩnh vực được phân công và kế hoạch công tác của cá nhân cụ thể về nội dung công việc, tiến độ thực hiện.</p>
            <p>+ Tham mưu tổ chức, chủ trì điều hành các cuộc họp, phiên họp, hội nghị, hội thảo.... chất lượng, hiệu quả.</p>
            <p>+ Chỉ đạo, điều hành, kiểm soát việc thực hiện nhiệm vụ của cơ quan, phòng chuyên môn đảm bảo kịp thời, không bỏ sót nhiệm vụ. Giải quyết công việc đúng quy trình, quy định.</p>
            <p>+ Triển khai, phân công nhiệm vụ và điều phối công việc cho cấp dưới linh hoạt, có chỉ đạo, định hướng, hướng dẫn...</p>
            <p>+ Bao quát, theo dõi, kiểm tra, đôn đốc việc thực hiện nhiệm vụ của cán bộ, viên chức, người lao động trong cơ quan, phòng chuyên môn và giải quyết kịp thời những khó khăn vướng mắc theo thẩm quyền.</p>
            <p>+ Có năng lực tập hợp cán bộ, viên chức, người lao động trong cơ quan, phòng chuyên môn đoàn kết, thống nhất. Phối hợp, tạo lập mối quan hệ tốt với các cá nhân, tổ chức có liên quan trong chỉ đạo, triển khai thực hiện nhiệm vụ.</p>
            <p>+ Thực hiện hiệu quả việc tiết kiệm thời gian, vật tư, tài sản, văn phòng phẩm, trang thiết bị của cơ quan trong điều hành và xử lý công việc.</p>
            <p>+ Các văn bản ban hành thuộc lĩnh vực tham mưu, phụ trách đảm bảo đúng thể thức, quy trình, thủ tục, không có sai sót, bảo đảm chất lượng, đúng tiến độ.</p>
            <p>- Đối với viên chức, người lao động:</p>
            <p>+ Chủ động nghiên cứu, cập nhật kịp thời các kiến thức pháp luật và chuyên môn nghiệp vụ để tham mưu, tổ chức thực hiện công việc có chất lượng, hiệu quả.</p>
            <p>+ Xây dựng kế hoạch công tác của cá nhân trên cơ sở kế hoạch phân công công tác của phòng gồm nội dung công việc, tiến độ thực hiện.</p>
            <p>+ Tham mưu có hiệu quả trong việc thực hiện nhiệm vụ được giao.</p>
            <p>+ Triển khai, hướng dẫn, đôn đốc, kiểm tra các đơn vị, cá nhân liên quan trong thực hiện nhiệm vụ thuộc lĩnh vực tham mưu đạt hiệu quả.</p>
            <p>+ Báo cáo kịp thời, chính xác với lãnh đạo về tình hình, kết quả thực hiện nhiệm vụ được giao. Chủ động tham mưu, đề xuất phương án, cách thức xử lý, giải quyết công việc.</p>
            <p>+ Thiết lập hồ sơ công việc đầy đủ theo nội dung công việc được phân công; lưu trữ, quản lý hồ sơ, tài liệu bảo đảm đúng nguyên tắc.</p>
            <p>+ Chủ động giải quyết công việc và phối hợp tốt với các cá nhân, đơn vị có liên quan giải quyết công việt đạt chất lượng, hiệu quả.</p>
            <p>+ Sử dụng thành thạo các phần mềm, ứng dụng công nghệ thông tin đáp ứng yêu cầu quản lý, điều hành, giải quyết công việc. Thực hiện hiệu quả việc tiết kiệm thời gian, vật tư, tài sản văn phòng phẩm, trang thiết bị của cơ quan trong tham mưu và xử lý công việc.</p>
            <p>+ Các văn bản ban hành thuộc lĩnh vực tham mưu đảm bảo đúng thể thức, quy trình, thủ tục, không có sai sót, bảo đảm chất lượng, đúng tiến độ.</p>
            <p>+ Thực hiện tốt các nhiệm vụ khác do lãnh đạo phòng giao.</p>
            <p>b) Kết quả thực hiện chức trách, nhiệm vụ được giao theo kế hoạch công tác được duyệt và các nhiệm vụ đột xuất **(tối đa 55 điểm)**</p>
            <p>- Hoàn thành từ 90% đến 100% công việc theo kế hoạch, lịch công tác đảm bảo tiến độ, chất lượng: 46-55 điểm.</p>
            <p>- Hoàn thành từ 80% đến dưới 90% công việc theo kế hoạch, lịch công tác đảm bảo tiến độ, chất lượng: 41-45 điểm.</p>
            <p>- Hoàn thành từ 70% đến dưới 80% công việc theo kế hoạch, lịch công tác đảm bảo tiến độ, chất lượng: 36-40 điểm.</p>
            <p>- Hoàn thành từ 60% đến dưới 70% công việc theo kế hoạch, lịch công tác đảm bảo tiến độ, chất lượng: 31-35 điểm.</p>
            <p>- Hoàn thành dưới 60% công việc: Dưới 30 điểm</p>
            <p>3. Điểm thưởng **(tối đa 5 điểm)**</p>
            <p>- Cán bộ, viên chức, người lao động khi được Ban giám đốc tuyên dương về thành tích thực hiện nhiệm vụ chuyên môn tại buổi giao ban hàng tháng được cộng thêm 3 điểm.</p>
            <p>- Đối với cán bộ, viên chức, người lao động tham mưu đóng góp ý kiến được áp dụng vào chuyên môn hoặc hoạt động khác mang tính đột phá, đem lại lợi ích, hiệu quả thiết thực cho cơ quan, đơn vị hoặc tham mưu ban hành văn bản (tối thiểu 10 văn bản - tính trên hệ thống quản lý hồ sơ công việc) được cộng thêm 2 điểm.</p>
            <p>4. Điểm trừ **(tối đa 30 điểm)**</p>
            <p>- Các phòng, đơn vị triển khai phối hợp chưa đạt theo Quy định tại Điều 4 Quy chế phối hợp công tác giữa các phòng thuộc Ban QLDA thì đối với mỗi nội dung phối hợp được đánh giá chưa đạt thì Lãnh đạo phòng trừ 2 điểm, cán bộ chủ trì được giao phối hợp trừ 4 điểm.</p>
            <p>- Đối với các phòng khi bị Ban giám đốc Ban QLDA phê bình tại buổi giao ban hàng tháng thì Lãnh đạo phòng bị trừ 5 điểm, thành viên trong phòng bị trừ 3 điểm.</p>
            <p>- Đối với cá nhân cán bộ, viên chức, người lao động khi bị Ban giám đốc phê bình tại buổi giao ban hàng tháng thì bị trừ 3 điểm, Lãnh đạo phòng có cá nhân thuộc đơn vị bị giám đốc phê bình bị trừ 2 điểm; bị các đoàn Thanh tra, Kiểm toán kiến nghị xem xét kỷ luật thì bị trừ 5 điểm, Lãnh đạo phòng có cá nhân thuộc đơn vị bị giám đốc phê bình bị trừ 3 điểm; bị UBND tỉnh, các đoàn Thanh tra, Kiểm toán kiến nghị xem xét yêu cầu kiểm điểm rút kinh nghiệm thì bị trừ 1 điểm/ 1 nội dung kiểm điểm.</p>
            <p>- Đối với cán bộ, viên chức, người lao động vi phạm kỷ luật kỷ cương hành chính thì bị trừ 2 điểm nếu vi phạm 1 lần; vi phạm lần tiếp theo cộng thêm 1 điểm/lần; chịu trách nhiệm chính xử lý công việc trên hệ thống quản lý hồ sơ công việc bị chậm thì bị trừ 2 điểm.</p>
            <p>- Đối với các phòng chậm gửi báo cáo kết quả - kế hoạch hàng tháng thì Lãnh đạo phòng bị trừ 5 điểm, cán bộ chủ trì bị trừ 3 điểm.</p>
            <p>- Đối với cán bộ, viên chức, người lao động vi phạm trật tự an toàn giao thông có văn bản của lực lượng chức năng thì bị trừ 10 điểm.</p>
          </div>
        )
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>- Hoàn thành nhiệm vụ (xếp loại B): Đạt từ 50 đến dưới 70 điểm.</p>
            <p>- Không hoàn thành nhiệm vụ (xếp loại C): Dưới 50 điểm.</p>
          </div>
        )
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>4. Đối với trường hợp viên chức, người lao động được cử đi học tập trung, thoát ly công việc cơ quan trên 30 ngày/năm làm việc thì căn cứ vào kết quả học tập để đánh giá, mức xếp loại tối đa là hoàn thành tốt nhiệm vụ (xếp loại A).</p>
            <p>Trường hợp khi chưa có kết quả học tập, tạm thời xếp loại A và khi có kết quả học tập sẽ điều chỉnh xếp loại (Kết quả học tập đạt loại giỏi, loại khá thì xếp loại A; đạt loại trung bình thì xếp loại B; kết quả học tập dưới trung bình hoặc không hoàn thành khóa học thì xếp loại C).</p>
            <p>5. Đối với cán bộ, viên chức, người lao động chịu trách nhiệm chính trong xử lý công việc trong tháng khi có văn bản phê bình của cơ quan cấp trên thì mức xếp loại của tháng tối đa là hoàn thành nhiệm vụ (xếp loại B); Lãnh đạo của phòng đó bị hạ 1 bậc xếp loại trong tháng.</p>
            <p>6. Trường hợp xếp loại ở mức khác do Giám đốc Ban QLDA xem xét, đánh giá và quyết định.</p>
          </div>
        )
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>- Bước 3: Gửi kết quả xếp loại hàng tháng đến bộ phận tổng hợp thuộc phòng Hành chính - Tổng hợp trước 10h00 ngày 05 của tháng kế tiếp. Hồ sơ gồm: (i) Biên bản họp đánh giá, xếp loại của phòng; (ii) Danh sách tổng hợp kết quả đánh giá, xếp loại đối với viên chức, người lao động.</p>
            <p>- Bước 4: Trên cơ sở kết quả đánh giá, xếp loại hàng tháng, Phòng Hành chính - Tổng hợp kiểm tra, rà soát, tham mưu, tổng hợp kết quả đánh giá, xếp loại trình Hội đồng thi đua, khen thưởng, đánh giá, xếp loại Ban QLDA.</p>
            <p>- Bước 5: Ban Giám đốc tổ chức kiểm điểm, tự đánh giá, xếp loại các đ/c trong Ban Giám đốc; Hội đồng thi đua, khen thưởng, đánh giá, xếp loại Ban QLDA xem xét, quyết định kết quả đánh giá, xếp loại của Phó phòng, viên chức, người lao động; tổ chức nhận xét, đánh giá xếp loại các đ/c trong Ban giám đốc; các đ/c trưởng phòng; tập thể các phòng; tập thể Ban QLDA (bằng hình thức bỏ phiếu kín để khẳng định sự tín nhiệm). Mức xếp loại của các đ/c trong Ban giám đốc và lãnh đạo các phòng không cao hơn kết quả xếp loại của đơn vị mình được giao quản lý, phụ trách.</p>
            <p>- Bước 6: Công khai kết đánh giá, xếp loại viên chức, người lao động tại Hội nghi viên chức và người lao động hoặc mạng thông tin nội bộ của cơ quan.</p>
            <p>Các vấn đề khiếu nại về công tác đánh giá, xếp loại sẽ do Giám đốc Ban QLDA xem xét, quyết định theo quy định về phân cấp quản lý cán bộ.</p>
          </div>
        )
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>4. Trình tự, thủ tục giải quyết kiến nghị về kết quả xếp loại chất lượng thực hiện theo quy định tại Điều này và theo quy chế của đơn vị. Không xem xét lại kết quả giải quyết kiến nghị.</p>
          </div>
        )
      },
      {
      ...
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>- Phụ lục 04: Bảng tổng hợp kết quả đánh giá, xếp loại đối với cán bộ, viên chức, người lao động của phòng chuyên môn.</p>
            <p>- Phụ lục 05: Bảng tổng hợp, rà soát kết quả đánh giá, xếp loại.</p>
            <p>- Phụ lục 06: Báo cáo kết quả thực hiện nhiệm vụ và kế hoạch tháng …</p>
            <p>- Phụ lục 07: Báo cáo tiến độ xử lý văn bản trên Hệ thống quản lý hồ sơ công việc; xử lý hồ sơ qua Bộ phận một cửa,</p>
            <p>- Phụ lục 08: Báo cáo chấp hành kỷ luật, kỷ cương hành chính;.</p>
            <p>#</p>
          </div>
        )
      },
      ...
      },
      {
        ...
        content: (
          <div className="space-y-3 text-txt-secondary">
            ...
            <p>3) Thực hiện chấm điểm thi đua, đánh giá, xếp loại đối với đơn vị theo phân công, phân cấp; gửi hồ sơ, thủ tục, kết quả đánh giá, xếp loại về phòng Hành chính - Tổng hợp trước ngày 05 của tháng kế tiếp.</p>
            <p>4) Báo cáo kết quả thực hiện trong tháng của phòng (Báo cáo kết quả thực hiện; Kế hoạch thực hiện của tháng tiếp theo của phòng, của từng cá nhân thuộc phòng) về phòng Kế hoạch - Đâu thầu trước ngày 25 hàng tháng; Kế hoạch thực hiện quý của phòng, cá nhân trước 05 của tháng đầu tiên; Kế hoạch năm của phòng, cá nhân trong quý I.</p>
          </div>
        )
      },
      {
