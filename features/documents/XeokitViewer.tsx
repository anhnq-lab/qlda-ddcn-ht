        ...
        <div className="rounded-2xl overflow-hidden flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-slate-700/50 shadow-sm"
            ...
            <div className="h-12 bg-gradient-to-r from-slate-800 to-slate-900 border-b border-slate-700/50 flex items-center justify-between px-4 shrink-0">
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 rounded-lg border border-slate-600/30">
                ...
                <div className="flex items-center gap-2">
                    {/* View buttons */}
                    <div className="flex bg-slate-50 rounded-lg p-0.5 border border-slate-700/50">
                        {[
            ...
            <div className="flex-1 flex overflow-hidden">
                {/* LEFT TOOLBAR */}
                <div className="w-12 bg-slate-50 border-r border-slate-700/30 flex flex-col items-center py-3 gap-1 shrink-0">
                    ...
                    <div className="h-px w-6 bg-slate-50 my-1" />
                ...
                {/* MODEL TREE */}
                {showModelTree && (
                    <div className="w-56 bg-slate-50 border-r border-slate-700/30 flex flex-col shrink-0">
                ...
                <div className="flex-1 relative">
                    ...
                    {/* Loading overlay */}
                    {isLoading && (
                        <div className="absolute inset-0 bg-slate-50 flex items-center justify-center z-10 backdrop-blur-sm">
                ...
                {/* PROPERTIES PANEL */}
                <div className="w-64 bg-slate-50 border-l border-slate-700/30 flex flex-col shrink-0">
