                                            ...
                                            <div className="flex items-center -space-x-1.5 overflow-hidden">
                                                {(() => {
                                                    ...
                                                    if (allUsers.length === 0) {
                                                        return <span className="text-[9px] text-slate-300 dark:text-slate-600 italic">Chưa gán</span>;
                                                    }

                                                    // Giới hạn hiển thị tối đa 3 người, còn lại hiện +N
                                                    ...
                                                    return (
                                                        <>
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        <Avatar
                                                                            ...
                                                                            size="xs"
                                                                            className={`ring-1 ${isLead ? 'ring-blue-500 shadow-blue-200' : role === 'primary' ? 'ring-primary-400' : 'ring-emerald-300'} dark:ring-slate-800 shadow-sm hover:scale-105 hover:z-10 transition-transform`}
                                                                        />
                                                                        {isLead && (
                                                                            <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-blue-500 text-white text-[6px] font-black rounded-full flex items-center justify-center border border-white dark:border-slate-800" title="Đầu mối chịu trách nhiệm">★</span>
                                                                        )}
                                                                    </div>
                                                                );
                                                            })}
                                                            {remainingCount > 0 && (
                                                                <div 
                                                                    className="w-6 h-6 rounded-full bg-slate-100 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 flex items-center justify-center text-[9px] font-bold text-txt-muted shrink-0 z-0"
