...
export const BimPropertiesPanel: React.FC<BimPropertiesPanelProps> = ({
    ...
    return (
        <div className={`
            ...
            ${isBottomPanel ? '' : isDarkMode ? 'bg-slate-800/95 border-slate-700/50' : 'bg-bg-surface border-gray-200'}
                                        ...
                                        {selectedElement.relations.map((rel, i) => (
                                            <button
                                                ...
                                                className={`
                                                    ...
                                                    ${isDarkMode ? 'bg-slate-700/30 border-slate-700/50 hover:bg-slate-700/60' : 'bg-bg-subtle border-gray-200 hover:bg-gray-100'}
                                                `}
                                            >
                                                <div className="flex items-center gap-2 mb-1">
                                ...
                                {selectedElement.classifications && selectedElement.classifications.length > 0 ? (
                                    <div className="space-y-2">
                                        {selectedElement.classifications.map((cls, i) => (
                                            <div key={i} className={`p-2.5 rounded-lg border ${isDarkMode ? 'bg-slate-700/30 border-slate-700/50' : 'bg-bg-subtle border-gray-200'}`}>
                                                <div className="flex items-center gap-2 mb-1">
