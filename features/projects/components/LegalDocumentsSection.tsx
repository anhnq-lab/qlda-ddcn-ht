...
export const LegalDocumentsSection: React.FC<LegalDocumentsSectionProps> = ({
    ...
    return (
        <div className="space-y-3">
            ...
            {investmentPolicy && (
                <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                    <button
                        onClick={() => toggleCard('policy')}
                        className="w-full px-4 py-3 flex items-center justify-between hover:bg-slate-50 dark:bg-slate-800 transition-colors"
                    >
                    ...
                    {expandedCard === 'policy' && (
                        <div className="px-4 pb-4 border-t border-gray-200 pt-3 space-y-2 bg-slate-50 dark:bg-slate-800">
