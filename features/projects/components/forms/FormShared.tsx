...
export const inputClass = "w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-slate-600 bg-bg-surface text-txt-primary dark:placeholder:text-slate-500 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-all shadow-sm";
export const inputWithIconClass = "w-full pl-9 pr-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-slate-600 bg-bg-surface text-txt-primary dark:placeholder:text-slate-500 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-all shadow-sm";
export const selectClass = "w-full px-3 py-2 text-sm rounded-xl border border-solid border-gray-200 dark:border-slate-600 bg-bg-surface text-txt-primary focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-all shadow-sm";
export const selectWithIconClass = "w-full pl-9 pr-8 py-2 text-sm rounded-xl border border-solid border-gray-200 dark:border-slate-600 bg-bg-surface text-txt-primary focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-all shadow-sm";
export const labelClass = "block text-xs font-semibold text-txt-secondary mb-1.5";
export const iconClass = "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-txt-placeholder";
    ...
    return (
        <div className={Icon ? "relative" : ""}>
            <input
                ...
                onBlur={handleBlur}
            />
            {Icon && <Icon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-txt-placeholder" />}
        </div>
    );
};
