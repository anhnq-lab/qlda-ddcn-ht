        ...
        <div className="flex flex-col gap-4 mb-5">
            <div className="flex items-center justify-between">
                ...
                <div className="grid grid-cols-3 gap-3">
                    <StatCard label="Tổng văn bản" value={stats.total} color="slate" icon={<FileText className="w-5 h-5"/>} />
                    <StatCard label="Điều khoản" value={stats.totalArticles} color="amber" icon={<Layers className="w-5 h-5"/>} />
                    <StatCard label="Còn hiệu lực" value={stats.active} color="blue" icon={<ShieldCheck className="w-5 h-5"/>} />
                </div>
            </div>
