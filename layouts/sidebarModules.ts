...
export const navItems: NavItem[] = [
  ...
  { name: 'Quản lý nhân sự', path: '/employees', icon: UserCircle, resource: 'employees' },
  { name: 'Quản lý tài sản', path: '/tai-san-cong', icon: Landmark, resource: 'projects' },
  { name: 'Quản lý nhà thầu', path: '/contractors', icon: Users, resource: 'contractors' },
